...
export class ResolvedRecordGraphBuilder {
    ...
    async build(
        ...
        //     // 🔥 IMPORTANT: collect from graph nodes, not frontier
        ...
        //     const nextFrontier: DataRecord[] = [];

        //     const idsToFetch = new Set<string>();

        //     // --------------------------------------------------
        //     // collect ids for this hop
        //     // --------------------------------------------------

        //     for (const record of frontier) {

        //         const value = record.data?.[step.field];
        ...
        //     // --------------------------------------------------
        //     // fetch referenced records in batch
        //     // --------------------------------------------------
        ...
        //         // attach reference
        //         sourceNode.refs.set(step.field, target.id);

        //         nextFrontier.push(target);

        //         new Notice(
        //             `EDGE: ${sourceNode.schema}:${sourceNode.id} -> ${step.field} -> ${target.id}`
        //         );
        //     }

        //     new Notice(
        //         `STEP ${step.field} (${step.from} → ${step.to})`
        //     );
